...
export function PromSettingsModal({ onClose }: Props) {
  ...
  return (
    <ModalBase title="Prom.ua — Налаштування" icon="🛒" onClose={onClose}>
      ...
      {loading ? (
        ...
        <HoroshopFieldsEditor
          ...
          onSave={handleSave}
          hint="Додайте характеристики які будуть з’являтись у формі при заповненні товару для Prom.ua. Наприклад: Колір, Матеріал, Розмір."
        />
      )}
